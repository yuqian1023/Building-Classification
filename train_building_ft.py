...
tf.app.flags.DEFINE_integer('summary_snapshot_steps', 500,
                            'Summary save steps.')

tf.app.flags.DEFINE_integer('model_snapshot_steps', 500,
                            'Model save steps.')
...
def _get_init_fn():
  ...
  if tf.train.latest_checkpoint(FLAGS.train_dir):
    ...
    print('Search the latest checkpoint from train_dir.')
